...
<div class="kw-settings-section">
    ...
    <div class="kw-settings-field">
        <label for="kw_crossword_openai_api_key"><?php esc_html_e('OpenAI API Key', 'wp-quiz-plugin'); ?></label>
        <input type="text" id="kw_crossword_openai_api_key" name="kw_crossword_openai_api_key" value="<?php echo esc_attr($api_key); ?>" class="regular-text">
    ...
    <div class="kw-settings-field">
        ...
        <select id="kw_crossword_openai_model" name="kw_crossword_openai_model" class="regular-select">
    ...
    <div class="kw-settings-field">
        ...
        <input type="number" step="0.1" id="kw_crossword_openai_temperature" name="kw_crossword_openai_temperature" value="<?php echo esc_attr($temperature); ?>" class="small-text" min="0" max="1">
