...
$max_tokens = get_option('kw_wordsearch_openai_max_tokens', 499);
...
<div class="kw-settings-section">
    ...
    <div class="kw-settings-field">
        ...
        <input type="number" id="kw_wordsearch_openai_max_tokens" name="kw_wordsearch_openai_max_tokens" value="<?php echo esc_attr($max_tokens); ?>" class="small-text" min="50" max="499">
