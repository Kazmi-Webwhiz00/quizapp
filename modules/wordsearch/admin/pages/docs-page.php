...
function ws_render_docs_page() {
    ...
    <p><?php esc_html_e('Below are the available shortcodes for the Quiz ,Crossword and Wordsearch modules. Click "Copy" to copy the shortcode to your clipboard.', 'wp-quiz-plugin'); ?></p>
