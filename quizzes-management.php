                                            ...
                                            $.ajax({
                                                ...
                                                error: function (xhr, status, error) {
                                                    ...
                                                    if (retryCount > 0) {
                                                        ...
                                                        var errorMsg = 'Failed to generate question. ';
                            ...
                            answersHtml += `
                                <div class="kw_answer-item kw_column-item">
                                   ...
                                   <span class="kw_upload-image-btn">
                                    ...
                                    <label><input type="checkbox" name="quiz_questions[${index}][answers][${i}][correct]" ${correctAnswerLetter === String.fromCharCode(65 + i) ? 'checked' : ''}></label>
