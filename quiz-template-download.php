...
function kw_download_quiz_pdf_callback() {
    ...
    $pdf_quiz_title = get_option('wp_quiz_plugin_pdf_download_quiz_title',  __('Quiz Download', 'wp-quiz-plugin'));
    $pdf_student_name = get_option('wp_quiz_plugin_pdf_student_name', __('Student Name:', 'wp-quiz-plugin'));
    $pdf_date_text = get_option('wp_quiz_plugin_pdf_date_text', __('Date:', 'wp-quiz-plugin'));
    ...
    $pdf->Cell(0, 10, __($quiz_title, 'wp-quiz-plugin'), 0, 1, 'C');
    $pdf->Ln(5);

    $pdf->SetFont($student_date_font_family, '', $student_date_font_size);
    $pdf->SetTextColorArray(hex2rgb($student_date_font_color));
    $pdf->SetFillColorArray(hex2rgb($student_date_background_color));
    $pdf->Cell(120, 10, __($pdf_student_name, 'wp-quiz-plugin') . ' _______________________', 0, 1, 'L', 1);
    $pdf->Ln(5);
    $pdf->Cell(60, 10, __($pdf_date_text, 'wp-quiz-plugin') . ' ___________', 0, 1, 'L', 1);
    $pdf->Ln(10);
